 ...
 * Versi Turbo: Instant Camera, GPS Alamat, & Fix Auto-Update Button
 */
const absensi = {
    stream: null,
    location: null,
    ...
    async renderButtons() {
        ...
        container.innerHTML = '<div style="text-align:center; padding:10px;"><i class="fas fa-sync fa-spin"></i> Mengecek Status...</div>';
        ...
        try {
            ...
            // SIMPAN KE CACHE AGAR BISA DIPAKAI SAAT SUBMIT
